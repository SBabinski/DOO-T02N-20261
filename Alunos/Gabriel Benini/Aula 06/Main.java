...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("[5] - Gerenciar Vendedores e Clientes");
    ...
    public static void adicionarVendedor(Scanner scan) {
        ...
        Vendedor v = new Vendedor(nome, idade, lojaPrincipal, cidade, bairro, rua, salarioBase);
