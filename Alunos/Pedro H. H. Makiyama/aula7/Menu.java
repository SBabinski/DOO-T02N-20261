...
public class Menu {
    ...
    private Loja loja1 = new Loja("nomefant1", "razsoc1", 123, "estado1", "cidade1", "bairro1", "rua1", 430, "prédio");    
            ...
            switch (opcao){
                ...
                case 4:
                    ...
                    if (opcao == 2){
                        ...
                        loja1.cadastrarVendedor(nome, idade, loja, estado, cidade, bairro, rua, numero, complemento, salariobase);
                    ...
                    if (opcao == 4){
                        ...
                        loja1.apresentarMediasSalariosVendedores();
                    ...
                    if (opcao == 5){
                        ...
                        loja1.apresentarBonusVendedores();
                        ...
                        for (Vendedor vended : loja1.getVendedores()){
                            ...
                            if (vended.getNome().equals(nome)){
                                ...
                                System.out.println("[1] - Alterar Nome\n" +
                                                   ...
                                                   "[7] - Alterar Rua\n" +
                                                   "[8] - Alterar Número\n" +
                                                   "[9] - Alterar Complemento\n" +
                                                   "[10] - Alterar Salário Base\n" +
                                                   "[11] - Voltar\n");
                                ...
                                if (opcao == 9){
                                    ...
                                    vended.setComplemento(complemento);
                ...
                case 5:
                    ...
                    if (opcao == 1){
                        ...
                        System.out.println("\nQuantidade de gerentes: " + loja1.contarGerentes());
                    ...
                    if (opcao == 2){
                        ...
                        loja1.cadastrarGerente(nome, idade, loja, estado, cidade, bairro, rua, numero, complemento);
                    ...
                    if (opcao == 4){
                        ...
                        loja1.apresentarMediasSalariosGerentes();
                    ...
                    if (opcao == 6){
                        ...
                        System.out.println("\nDigite o nome do gerente a ter os dados alterados: ");
                        nome = scan.nextLine();

                        for (Gerente gerent : loja1.getGerentes()){

                            if (gerent.getNome().equals(nome))
                ...
                case 6:
                    ...
                    if (opcao == 2){
                        ...
                        System.out.println("\nDigite o número da residência do cliente: ");
                        numero = scan.nextInt();

                        scan.nextLine();

                        System.out.println("\nDigite o complemento da residência do cliente: ");
                        complemento = scan.nextLine();

                        loja1.cadastrarCliente(nome, idade, estado, cidade, bairro, rua, numero, complemento);
